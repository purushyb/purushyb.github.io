...
| :--- | :--- |
| **Mobile** | Android (Kotlin/Java), Flutter (Dart), iOS (Swift), KMP |
| **Architecture** | MVVM, Clean Architecture, Jetpack Compose, Multi-module |
| **Backend/Cloud** | Node.js, GCP, Docker, Firebase |
| **AI/ML** | TensorFlow, Python, NLP, Computer Vision |

---

### 🌟 Open Source & Community
I am a strong believer in the power of open-source software. Through [KarnaForge](https://karnaforge.dev), I maintain several projects aimed at improving developer productivity and user utility. I also contribute to major global repositories, including **TensorFlow, Meta, and Google**.
...
### 📫 Get in Touch
* **LinkedIn:** [purushyb](https://www.linkedin.com/in/purushyb)
* **GitHub:** [purushyb](https://github.com/purushyb)
* **Portfolio:** [purushyb.github.io/masterPortfolio](https://purushyb.github.io/masterPortfolio)
* **Email:** [purushottamyadavbattula@gmail.com](mailto:purushottamyadavbattula@gmail.com)

---
> "Building software isn't just about writing code; it's about crafting experiences that simplify lives."